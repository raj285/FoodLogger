...
const percentageCalculationOfNutrientsIntake = (totalDays, Nu, dailyIntake) => {
...
const Trends = () => {
  ...
  console.log("Total dates are: " + totalDays);
...
const [vitaminK, setVitaminK] = useState(0);
  ...
  setStarch(res?.data?.nutrientsData?.nutrients?.carbohydrates?.starch || 0);
  setSucrose(res?.data?.nutrientsData?.nutrients?.carbohydrates?.sucrose || 0);
  ...
  setVitaminB1(res?.data?.nutrientsData?.nutrients?.vitamins?.vitaminB1 || 0);
  setVitaminB2(res?.data?.nutrientsData?.nutrients?.vitamins?.vitaminB2 || 0);
  setVitaminB3(res?.data?.nutrientsData?.nutrients?.vitamins?.vitaminB3 || 0);
  setVitaminB5(res?.data?.nutrientsData?.nutrients?.vitamins?.vitaminB5 || 0);
  setVitaminB6(res?.data?.nutrientsData?.nutrients?.vitamins?.vitaminB6 || 0);
  setVitaminB12(res?.data?.nutrientsData?.nutrients?.vitamins?.vitaminB12 || 0);
  ...
  return (
    <div className="bg-MainPage1">
      {/* input of dates */}
      <div className="text-white">input for date will come here</div>
      {/* boxes for trends */}
